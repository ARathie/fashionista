...
allowed_product_names= ['Spike Birdseye Cardigan Sweater Vest', 'Clint Stripe Oxford Work Shirt', 'Palmer Solid Performance Polo', 'Slider Brushed Fleece Crewneck', 'Beckett Check Performance Polo', 'Raynor Performance Polo', 'Blount Quarter-Zip Sweater', 'Carter Stripe Performance Polo', 'Jacob Shirt Jacket', 'Harvey Windowpane Performance Pique Polo', 'Carter Stripe Performance Polo University of Tennessee', 'Carter Stripe Quarter-Zip Pullover', 'Turtleson Tour Visor', 'Slater Performance Polo', 'Callahan Plaid Sport Shirt', 'Wallace Quarter-Zip Pullover', 'Quincy Performance Polo', 'Edward Stripe Performance Polo', 'Turtleson Performance Cap', 'Everett Cotton Polo', 'Merino Mouline Shawl V-Neck Sweater', "Women's Siro Long Sleeve Full-Zip Jacket", "Women's Becca Check Performance Polo", 'Spike Birdseye Cardigan Sweater', 'Brew Performance Polo', "Women's Azalea Performance Polo", 'Turtleson Twill Cap', 'Royal Oxford Parker Stripe Polo', 'Solid Performance Polo, Knit Collar', 'Dane Herringbone Work Shirt', 'Wallace Crewneck', 'McClure Full-Zip Vest', 'Clarence Mini Diamond Jacquard Performance Polo', "Women's Gabrielle Performance Polo", "Women's Solid Performance Polo", 'Royal Oxford Solid Polo', 'Reid Performance Polo', 'Anderson Performance Short', 'Bristol Twill Hybrid 5-Pocket Pant', 'Remy Quarter-Zip Pullover', 'Siro Quarter-Zip Pullover Vest', 'Wagner Merino Roll Neck Sweater', 'Hudson Houndstooth Work Shirt', 'Logan Long Sleeve Stripe Popover', 'Baldwin Check Performance Polo', 'Fusion Jacket', 'Vincent Tortoise Shell Performance Polo', 'Rocky Performance Polo', 'Wallace Stripe Quarter-Zip Pullover', 'Easton Quarter-Zip Pullover', 'Reed Performance Polo', 'Logan Long Sleeve Popover', 'Lawton Performance Short', 'Blount Quarter-Zip Sweater Vest', 'Cooper Stripe Performance Polo - UNIVERSITY OF TENNESSEE', 'Kelly Performance Polo', 'Steele Full Zip Vest', 'Harris Performance Polo', 'Woods Stripe Performance Polo', 'Varsity Stripe Merino Crewneck Sweater', 'Sully Performance Polo', 'Lester Oxford Performance Polo', 'Wallace Quarter-Zip Vest', "Women's Ridley Performance Polo", 'Italian Merino Quarter-Zip Vest', 'Coastal 5-Pocket Pant', 'Simon Stripe Performance Polo', 'Eric Oxford Gingham Sportshirt', 'Mark Stripe Oxford Quarter-Zip Pullover', 'Royal Oxford Pierce Stripe Polo', 'Thatcher Stripe Performance Polo', 'Rory Stripe Performance Polo', "Women's Carter Stripe Performance Polo", 'Norman Mini Dot Performance Polo', 'Thistle Stretch Belt', 'Extra Fine Merino Quarter-Zip Vest', 'Ryan Stripe Performance Polo', 'Riley Polka Dot Sport Shirt', 'Merino Birdseye Quarter-Zip Sweater', 'Lawton 5 Pocket Performance Pant', 'Italian Merino Lined Quarter-Zip Sweater', 'Lennox Dot Performance Polo', 'Bailey Birdseye Performance Polo', 'Collin Polka Dot Sport Shirt', 'Dean Stripe Performance Polo', 'Italian Merino Wool Lined Full-Zip Sweater', 'Italian Merino Sweater Vest', 'Hagan Stretch Belt', 'Hardy Luxe Sweatshirt', 'Theo Performance Short', 'Miller Stripe Performance Polo', 'Beckett Check Performance Polo, Long Sleeve', 'Siro Quarter-Zip Pullover', 'Houndstooth Work Shirt', 'Steele Full Zip Jacket', 'Silas Kangaroo Crewneck Pullover', 'Lake Full-Zip Vest', 'Bristol Twill Short', 'Ike Stripe Crewneck Sweater', 'Winston Quarter Zip Pullover', 'Italian Merino Quarter-Zip Sweater', 'Pendry Oxford Quarter-Zip Pullover', 'Harlow Performance Polo', 'Wyatt Jacket', 'Hunter Snap Pullover', 'Fusion Quilted Vest', "Women's Cara Stripe Performance Polo", 'Jack Stripe Coastal Polo', 'Hayes Cashmere Quarter-Zip Pullover', 'Austin Oxford Stripe Work Shirt', 'Azalea Performance Polo', 'Garth Quarter-Zip Vest', 'Teddy Performance Polo', 'Griffin Performance Polo', 'Cooper Stripe Performance Polo', 'Ridley Performance Polo', 'Pendry Oxford Performance Long Sleeve Polo', 'Tye Paisley Pique Performance Polo', "Women's Solid Crewneck Sweater", 'Spike Rugby Stripe Cardigan Sweater', 'Nigel Corduroy Work Shirt', 'Riggs Water Resistant Quarter-Zip Pullover', 'Wallace Hoodie', 'Hibiscus Performance Polo', 'Plato Argyle Quarter-Zip Sweater', 'Greer Performance Polo', 'Birdseye Merino Quarter-Zip Sweater', 'Shelby Performance Polo', 'Anderson Performance Pant', 'Extra Fine Merino Milano-Stitch Quarter-Zip Sweater Vest', 'Skipper Performance Polo', 'Drake Performance', 'Flynn Stripe Performance Polo', 'Axl Quarter-Zip Pullover', 'Pendry Oxford Performance Polo', 'Extra Fine Merino Milano-Stitch Quarter-Zip Sweater', 'Carter Stripe Performance Polo, Long Sleeve', "Women's Vivienne Tortoise Shell Performance Polo", 'Stretch Woven Belt', 'Italian Merino Crewneck', 'Walt Birdseye Quarter Zip Pullover', 'Murphy Performance Polo', "Women's Payton Solid Performance Polo", 'Cruz Performance Polo', 'Nate Quarter-Zip Pullover', "Women's Clare Mini Diamond Jacquard Performance Polo", 'Hampton Performance Polo']
...
def infer_product_color_from_raw_colors_quick(product_info, name_to_color_map={}):
    """Infer the product color using the given product's description."""
    # Get the raw_colors from the database
    raw_color = product_info['raw_color']
    raw_colors = raw_color.split("/")
    print(f"Raw Colors: {raw_colors}")
    colors = []
    for color in raw_colors:
        color = color.strip().lower()
        if color in allowed_colors:
            ...
            try:
                ...
                print(f"Error inferring color for product with description '{product_info['description']}': {e}")
                return None
    return list(set(colors))


if __name__ == "__main__":
    uncolored_products = db_functions.get_uncolored_products_from_db(limit=10000, store_name="asos")
    for product_info in uncolored_products:
        inferred_colors = infer_product_color_from_raw_colors_quick(product_info, name_to_color_map=name_to_color_map)
